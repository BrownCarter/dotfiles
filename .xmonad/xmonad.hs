...
myScreenshot = "mate-screenshoot"

-- The command to use as a launcher, to launch commands that don't have
-- preset keybindings.
myLauncher = "rofi -show drun -show-icons -columns 3 -width 70"
...
myFont      = "xft:Zekton:size=9:bold:antialias=true,FontAwesome:size=10"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
 ...
 -- launch dmenu
  , ((modMask .|. shiftMask,   xK_d), spawn "dmenu_run")
